#pragma once
  ...
  //#define MARAUDER_C5
  //#define MARAUDER_CYD_C5 // NM-CYD-C5 (RockBase CYD, ESP32-C5)
...
#define PURE_WARDRIVER_VERSION "v1.0.2"
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "NM-CYD-C5"
 ...
 //// BOARD FEATURES
  ...
  #define PKT_AXIS_W  (WIDTH_1 - 10)
    ...
    // Keypad start position, key sizes and spacing (same 240x320 class as V8)
    #define KEY_X 120 // Centre of key
    #define KEY_Y 50
    #define KEY_W 240 // Width and height
    #define KEY_H 22
  ...
  //// GPS STUFF
    ...
    #elif defined(MARAUDER_CYD_C5)
      #define GPS_SERIAL_INDEX 1
      #define GPS_TX 5 // NM-CYD-C5 P5 LP-UART (external NM-ATGM336H)
      #define GPS_RX 4
    #endif
  #else
    #define mac_history_len 100
  ...
  //// STUPID CYD STUFF
      ...
      #define XPT2046_MOSI 7
      #define XPT2046_MISO 2
      #define XPT2046_CLK  6
      #define XPT2046_CS   1
    #endif
    ...
    #if defined(MARAUDER_C5) || defined(MARAUDER_CYD_C5)
      #define SD_MISO 2
      #define SD_MOSI 7
      #define SD_SCK  6
    #elif defined(MARAUDER_T_DONGLE_C5)
